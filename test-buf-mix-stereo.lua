...
function init()
    ...
    softcut.buffer_mix_stereo(file1,0,1,-1,0,1)
...
function key(n,z)
    if n == 3 and z == 1 then
        print_info(file2)
        softcut.buffer_mix_stereo(file2,0,1,-1,preserve,mix,1,1)
    elseif n == 2 and z == 1 then
        print_info(file1)
        softcut.buffer_mix_stereo(file1,0,1,-1,0,1,1,1)
    end
end
